...
<div dir="auto">
  ...
  <a class="list-inline-item"><iconify-icon icon="simple-icons:dotnet"></iconify-icon><script src="https://code.iconify.design/iconify-icon/1.0.7/iconify-icon.min.js"></script></a>
